...
import { getSimpleDOMStructure } from '../../helpers';
        ...
        [
          [
            ...
            [
              [
                'DIV',
                { class: 'tippy-content', 'data-state': 'visible' },
                [
                  [
                    'DIV',
                    {},
                    ['Popover', ['BUTTON', { type: 'button' }, ['Hide']]],
                  ],
                ],
              ],
      ...
      [
        ...
        [
          [
            'DIV',
            { class: 'my-popper' },
            [['DIV', { class: 'my-popper-box' }, ['Tooltip']]],
          ],
        ],
      ],
    ]);
      ...
      [
        ...
        [
          [
            'DIV',
            { class: 'my-popper' },
            [['DIV', { class: 'my-popper-box' }, ['foobar']]],
          ],
        ],
      ],
    ]);
      ...
      [
        ...
        [
          [
            'DIV',
            { class: 'my-popper' },
            [['DIV', { class: 'my-popper-box' }, ['updated']]],
          ],
        ],
      ],
    ]);
